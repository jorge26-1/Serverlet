...
<body>
    ...
    <form action="${pageContext.request.contextPath}/RegistrarHuertoServlet" method="post">
        Nombre del Huerto:
        <input type="text" name="nombre" required>

        Ubicación:
        <input type="text" name="ubicacion" placeholder="Ej. Norte, Lote 5" required>

        Tipo de Producción:
        <input type="text" name="tipoProduccion" placeholder="Ej. Frutas, Verduras" required>
